          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form action="" className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt assumenda accusamus hic quam, dicta natus deleniti? Impedit laborum saepe
              </p>
              {/* Inputs content*/}
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="wst">Consulting</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* Textarea content */}
